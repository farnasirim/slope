...
capacity of a single machine. \TODO{application programmers sounds a bit too
specific. What about: system designers design applications that can run on multiple
machines ...} System designers distribute applications among clusters of
machines to
