...
fall in that one partition only. This is desirable because locality.
Applications come up with their own way of sharing data to take
advantage of their limited data access or data sharing pattern. This improves
performance but propagates complexity to different design levels in the
application, making applications hard to maintain and reduces openness in their
design as they have to act in a more restricted way.
