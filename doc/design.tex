...
First in the computation model section we speculate what the api would look like

Introduce possible use cases of such a platform in distributed applications

from this we can come up with design goals and important performance metrics
and hints at the places where we need to be careful
...
\TODO{HEEEEEEEEEEEEEEEEEEEEEEERE}
...
Section \ref{sec:api} had discussed this in detail and \ref{sec:conform} will
